 ...
 */
@Singleton(name = "BloqueHorarioManagerEJB")
public class BloqueHorarioManager {

    final Logger LOGGER = LoggerFactory.getLogger(BloqueHorarioManager.class);

    @EJB
    public BloqueHorarioDAO bloqueHorarioDAO;

    public List<BloqueHorario> getBloquesHorario(){
        List<BloqueHorario> bloqueHorarios = bloqueHorarioDAO.findAll();
        return bloqueHorarios;
    }

    public BloqueHorario createBloqueHorario(BloqueHorario bloqueHorario){
        return bloqueHorarioDAO.create(bloqueHorario);
    }

    public boolean deleteBloqueHorario(BloqueHorario bloqueHorario){
        return bloqueHorarioDAO.delete(bloqueHorario);
    }

    public BloqueHorario getById(Long bloqueHorarioId){
        return bloqueHorarioDAO.getById(bloqueHorarioId);
    }

    public List<BloqueHorario> getEventsByRUT(String rut){
        return bloqueHorarioDAO.findByRut(rut);
    }
